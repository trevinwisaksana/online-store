...
const file_proto_user_user_proto_rawDesc = "" +
	"\n" +
	"\x15proto/user/user.proto\x12\x05order\x1a\x1cgoogle/api/annotations.proto\" \n" +
	...
	"\vUserService\x12O\n" +
	"\aGetUser\x12\x15.order.GetUserRequest\x1a\x16.order.GetUserResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/user/{id}B\x03Z\x01.b\x06proto3"
...
var file_proto_user_user_proto_goTypes = []any{
	...
	(*GetUserResponse)(nil), // 1: order.GetUserResponse
}
var file_proto_user_user_proto_depIdxs = []int32{
	0, // 0: order.UserService.GetUser:input_type -> order.GetUserRequest
	1, // 1: order.UserService.GetUser:output_type -> order.GetUserResponse
